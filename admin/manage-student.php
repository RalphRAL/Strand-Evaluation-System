  ...
  <ul class="list-unstyled components">
    ...
    <li class="dropdown active">
      ...
      <ul class="collapse show list-unstyled menu" id="pageUser">
        ...
        <li class="active"><a href="manage-student.php"><i class="material-icons" style="color: #2e6930;">&#8226;</i>Manage Students</a></li>
      </ul>
    </li>
			...
			<div class="card" style="min-height: 300px;">
				<div class="card-header card-header-text">
					...
					<div class="btn-group" role="group">
					  <a class="toggle-vis btn btn-primary btn-sm" data-column="1" style="cursor: pointer;">Name</a><a class="toggle-vis btn btn-primary btn-sm" data-column="2">Mobile #</a><a class="toggle-vis btn btn-primary btn-sm" data-column="3">E-mail</a><a class="toggle-vis btn btn-primary btn-sm" data-column="4">Account Status</a><a class="toggle-vis btn btn-primary btn-sm" data-column="5">Exam Status</a>
					</div>
				</div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!---- ADD STUDENT FORM ---->
        <form id="addStudentForm" action="controllers/addStudent.php" method="POST">
...
<!--JS Functions-->
<script src="../js/admin/manage-student.js"></script>
</body>
</html>