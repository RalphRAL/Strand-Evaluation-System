...
function countQuestions()
{
	...
	$.ajax({
		...
		method: "POST",
		data: {countQuestions:countQuestions, exam_id:exam_id},
		success:function(data){
			$('.countQuestions').html(data);
		}
	});
}
...
function fetchQuestions()
{
  ...
  $.ajax({
      url : "controllers/fetchQuestions.php",
      method: "POST",
...
function retrieveQuestion(id){
	...
	if(id){
		...
		$.ajax({
      url: 'controllers/retrieveQuestion.php',
      type: 'POST',
      data: {question_id : id},
      dataType: 'json',
      success:function(response) {
...
function retrieveExamDetails(id = $('#showID').val()) {
	if (id) {
		...
		$.ajax({
      url: 'controllers/retrieveExamDetails.php',
      type: 'POST',
      data: {exam_id : id},
      dataType: 'json',
      success:function(response) {
        ...
        if(response.exam_status == '1'){
        	$('.examStatus').html('Active').addClass('badge-success');
        } else {
        	$('.examStatus').html('Inactive').addClass('badge-secondary');
        }
...
function removeQuestion(id = null) {
	if(id) {
		...
		swalWithBootstrapButtons.fire({
	        ...
	        $.ajax({        
	          url: 'controllers/removeQuestion.php',
	          type: 'post',
	          data: {question_id : id},
	          dataType: 'json',
	          success:function(response) {
